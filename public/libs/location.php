...
function geoLocationUsers(){
    ...
    if(!isset($_COOKIE['stringLocation'])) {
        ...
        $url = json_decode(file_get_contents("http://api.ipinfodb.com/v3/ip-city/?key=f32121c88c4786b04c98378032615ef7c0655c39beec7a6e79d5e0553bdeea39&ip=" . $PublicIP . "&format=json"));
        //debug_arr($url);
